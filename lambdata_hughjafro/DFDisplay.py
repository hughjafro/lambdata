...
Class DFDispaly(object):
    ...
    def unlimited_columns(self):
            ...
            When dealing with dataframes with many columns, this function
            will allow all columns to be viewed.

            Using transpose or df.T, is a useful operation when
            viewing a dataframe with many features.
            '''
